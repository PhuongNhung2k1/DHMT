...
void chan() {
	//Trai
	// truoc
	instance = Translate(-0.29,-0.2,-0.38)* Scale(0.02,0.4,0.02);
	glUniformMatrix4fv(model_view_loc, 1, GL_TRUE, ctm* view_ban*instance);
	glDrawArrays(GL_TRIANGLES, 0, NumPoints);
	// sau
	instance = Translate(-0.29, -0.2, 0) * Scale(0.02, 0.4, 0.02);
	glUniformMatrix4fv(model_view_loc, 1, GL_TRUE, ctm* view_ban*instance);
	glDrawArrays(GL_TRIANGLES, 0, NumPoints);
	//phai
	//truoc
...
void veban() {
	...
	instance_ban = Translate(0, 0, -0.19);
	mat();
	instance_ban = RotateX(-anpha)* Translate(0, 0, 0.19);
	mat();
	chan();
}
void display( void )
